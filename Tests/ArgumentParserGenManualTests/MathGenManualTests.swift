...
final class MathGenManualTests: XCTestCase {
  func testMath_SinglePageManual() throws {
    try AssertGenManual(multiPage: false, command: "math", expected: #"""
  ...
  func testMath_MultiPageManual() throws {
    try AssertGenManual(multiPage: true, command: "math", expected: #"""
      .\" "Generated by swift-argument-parser"
      .Dd May 12, 1996
      .Dt MATH 9
      .Os

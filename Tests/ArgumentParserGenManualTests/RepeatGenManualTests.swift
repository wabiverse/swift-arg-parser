...
final class RepeatGenManualTests: XCTestCase {
  func testMath_SinglePageManual() throws {
    try AssertGenManual(multiPage: false, command: "repeat", expected: #"""
  ...
  func testMath_MultiPageManual() throws {
    try AssertGenManual(multiPage: true, command: "repeat", expected: #"""
      .\" "Generated by swift-argument-parser"
      .Dd May 12, 1996
      .Dt REPEAT 9
      .Os

...
final class RollDiceGenManualTests: XCTestCase {
  func testRollDice_SinglePageManual() throws {
    try AssertGenManual(multiPage: false, command: "roll", expected: #"""
  ...
  func testRollDice_MultiPageManual() throws {
    try AssertGenManual(multiPage: true, command: "roll", expected: #"""
      .\" "Generated by swift-argument-parser"
      .Dd May 12, 1996
      .Dt ROLL 9
      .Os

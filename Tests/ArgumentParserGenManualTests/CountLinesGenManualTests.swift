...
final class CountLinesGenManualTests: XCTestCase {
  func testCountLines_SinglePageManual() throws {
    guard #available(macOS 12, *) else { return }
    try AssertGenManual(multiPage: false, command: "count-lines", expected: #"""
  ...
  func testCountLines_MultiPageManual() throws {
    guard #available(macOS 12, *) else { return }
    try AssertGenManual(multiPage: true, command: "count-lines", expected: #"""
      .\" "Generated by swift-argument-parser"
      .Dd May 12, 1996
      .Dt COUNT-LINES 9
      .Os
